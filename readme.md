...
当前版本 / Current Version: **Beta v1.1.1**  
...
点击下载最新版本：[CatchChartEditor Beta v1.1.1 安装包](https://github.com/ChuanYuanNotBoat/Malody_Catch_Editor/releases/latest)

---

## Features / 功能特性

- Load / save `.mc/mcz` charts (JSON based)  
  读取/保存 `.mc/mcz` 谱面（基于 JSON）
...
3. Use the right panel to select mode (Note / Rain / Delete / Select)  
   右侧栏选择模式（普通音符 / 雨音符 / 删除 / 选择）  
4. Left-click to place / delete notes; Ctrl+drag to select  
   左键放置/删除音符；Ctrl+拖动框选  
...
Special thanks to **myhome** for the skin used in this editor.  
特别感谢 **myhome** 授权使用其制作的皮肤。
